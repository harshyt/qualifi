...
- **Future work:** Add phone extraction to the Anthropic AI analysis prompt and store in the `candidates` table.
...
- **Future work:** Add location extraction to the Anthropic AI analysis prompt and store in the `candidates` table.
